...
class App(tk.Tk):
    ...
    def actualizar_en_tiempo_real(self, epoca, pesos, errores_patron):
        ...
        # Actualizar Gráfica 1: Error por Patrón
        ...
        # Actualizar Gráfica 3: Recta de Separación
        ...
        self.canvas.draw()
        # AQUÍ ESTÁ EL CAMBIO: update() procesa todos los eventos, incluyendo clics.
        self.update()

        # Lógica de pausa gráfica
    ...
    # (El resto de la clase no tiene cambios importantes, se incluye por completitud)
    def crear_cabecera(self):
        ...
        try:
            img_escudo = Image.open("escudo.png").resize((80, 80), Image.Resampling.LANCZOS); self.foto_escudo = ImageTk.PhotoImage(img_escudo)
        ...
        try:
            img_logo = Image.open("logo.png").resize((80, 80), Image.Resampling.LANCZOS); self.foto_logo = ImageTk.PhotoImage(img_logo)
    ...
    def cancelar_entrenamiento(self): self.entrenamiento_cancelado = True
